...
public class Connection extends Thread {
    ...
    Connection(Socket socket_, MPEServer p) {
        ...
        try {
            ...
            brin = new BufferedReader(new InputStreamReader(in)); // , "UTF-16")); // adamh added the UTF-16 encoding
    ...
    void read(String msg) {
        //if (MPEPrefs.DEBUG) System.out.println("Client: " + uniqueName + " Raw receive: " + this + ": '" + msg + "'");
        ...
        //if (MPEPrefs.DEBUG) System.out.println("startsWith='"+startsWith+"'");
        ...
        switch(startsWith){
	        ...
	        case 'S':
	            ...
	            System.out.println("Connecting Client id=" + clientID);
	        ...
	        case 'D':   
	            if (parent.allConnected) {
	                ...
	                if (MPEPrefs.DEBUG) System.out.println("Receive: id=" + clientID + ": " + fc + "  match: " + parent.frameCount);
        ...
        while (running) {
            ...
            try {
                ...
                if (input != null) {
                    ...
                    killMe(); //adamh remed to see if could get flash to connect.
    ...
    public void killMe(){
        System.out.println("Removing Connection id=" + clientID);
        parent.killConnection(this);
        parent.drop(clientID);
        parent.reset(); //adamh added
        running = false;
    ...
    public void send(String msg) {
        ...
        try {
        	msg+="\n";
            dos.write(msg.getBytes()); // here may need to send in a charset to get UTF-16 out of it as well.
            dos.flush();
        } catch (IOException e) {
            e.printStackTrace();
        }
